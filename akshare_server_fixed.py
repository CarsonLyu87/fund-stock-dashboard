...
class AKShareHandler(BaseHTTPRequestHandler):
    ...
    def handle_stocks(self, codes):
        ...
        try:
            ...
            # 方法1: 使用 stock_zh_a_spot_em 获取所有A股数据
            try:
                print("正在获取A股实时数据...")
        ...
        try:
            ...
            for code in codes:
                try:
                    ...
                    # 使用 fund_em_open_fund_info 获取基金信息
                    # 注意: 需要正确的 indicator 参数
...
def main():
    ...
    print("  GET /funds?codes=[...]       - 获取基金数据")
    print("  GET /fund-detail?code=...    - 获取基金详情")
    print("  GET /search-funds?keyword=... - 搜索基金")
